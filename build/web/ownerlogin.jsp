	 ...
	 <div class="container">
		 ...
		 <li><a href="index.jsp"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Home</a></li>
			 ...
			 <li><a href="userlogin.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>User Login</a></li>
                         <li  class="active"><a href="ownerlogin.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admin Login</a></li>	
...
<div class="welcome">
	 <div class="container">
		 <div class="welcome-top">
			 <h3><strong>Owner Login</strong></h3>
                         <form action="ownerlogin" method="post">
                             <br>
			   <table width="372" height="93" border="0" align="center">
                 <tr>
                   <td width="139" height="32"><strong>Enter Username</strong></td>
                   <td width="223"><input name="uname" type="text" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Name';}" value="Name" required=""></td>
                 </tr>
                 <tr>
