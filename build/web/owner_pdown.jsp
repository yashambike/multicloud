    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="top-menu">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="owner_pdown.jsp"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>Grant Download Permision</a></li>
            ...
            <div class="container">			
               ...
               window.onload=function(){
                  ...
                  $(".download").click(function () {
                       var id = document.getElementById('pd');
 
             if(id.value == '')
            {
                alert('Please request Id');
                return false;
            }
            return true;
                    });
        ...
        String s="select * from request where owner='"+s1+"'";
            ...
            %>
                        ...
                        <form action="owner_pdownload" method="post" name="login" ">
                            <center>
                            <br> Enter The Request Id  To  Grant Download Access<br>
                            <input type="text" name="pd" id="pd"><br>
                            <input style="color: #FF008C" type="submit" class="download" value=" Allow Download">
                            </center>
                        </form>
    </div>
                <div class="charitys">
