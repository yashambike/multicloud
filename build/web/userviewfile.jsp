    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="top-menu">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="userviewfile.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>View File  </a></li>
        ...
        <div class="welcome">
            <div class="container">
                ...
                <form name="login" action="userhome.jsp" method="post" onsubmit="return valid();">
