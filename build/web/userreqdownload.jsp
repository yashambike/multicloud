    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="top-menu">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="userreqdownload.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Request Download Permision </a></li>
        ...
        <div class="banner">
          ...
          window.onload=function(){
                  ...
                  $(".submit").click(function () {
                       var d = document.getElementById('dwnreqid');
        ...
        <div class="welcome">
            <div class="container">
                ...
                <form name="login" action="userdownreq" method="post" onsubmit="return valid();">
                    Enter The File Id To Request Download Permission <br>
                    <input type="text" name="dwnreqid" id="dwnreqid"><br>
                    <input style="color:#FF008C"class="submit" type="submit" value="Submit">
